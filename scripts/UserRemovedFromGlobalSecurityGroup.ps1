$Message = Get-WinEvent -LogName WEC3-Account-Management | Where-Object {$_.Id -eq 4729} | Select-Object -First 1 | Select-Object -ExpandProperty Message

# Modify below this comment to fit your needs
$Email = @{
    To = 'email@domain.com'
    From = 'SecurityAlerts@domain.com'
    Subject = '[WEFC Alert] A user was removed from a security-enabled global group'
    Body = $message
    Priority = 'High'
