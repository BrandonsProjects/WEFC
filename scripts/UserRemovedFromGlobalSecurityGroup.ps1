$Message = Get-WinEvent -LogName ForwardedEvents | Where-Object {$_.Id -eq 4729} | Select-Object -First 1 | Select-Object -ExpandProperty Message

$Email = @{
    To = 'email@domain.com'
    From = 'SecurityAlerts@domain.com'
    Subject = 'A user was removed from a security-enabled global group'
    Body = $message
    Priority = 'High'
